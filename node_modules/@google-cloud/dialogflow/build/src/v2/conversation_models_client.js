...
class ConversationModelsClient {
    ...
    constructor(opts) {
        ...
        this.pathTemplates = {
            ...
            projectConversationModelEvaluationsEvaluationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/conversationModels/{conversation_model}/evaluations/evaluation'),
            ...
            projectLocationConversationModelEvaluationsEvaluationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/conversationModels/{conversation_model}/evaluations/evaluation'),
    ...
    async checkCreateConversationModelProgress(name) {
        ...
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createConversationModel, gax.createDefaultBackoffSettings());
    ...
    async checkDeleteConversationModelProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deleteConversationModel, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    ...
    async checkDeployConversationModelProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deployConversationModel, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    ...
    async checkUndeployConversationModelProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.undeployConversationModel, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    ...
    async checkCreateConversationModelEvaluationProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createConversationModelEvaluation, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
     ...
     * @returns {string} Resource name string.
     */
    projectConversationModelEvaluationsEvaluationPath(project, conversationModel) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectConversationModelEvaluationsEvaluationName(projectConversationModelEvaluationsEvaluationName) {
        return this.pathTemplates.projectConversationModelEvaluationsEvaluationPathTemplate.match(projectConversationModelEvaluationsEvaluationName).project;
    }
    /**
     ...
     * @returns {string} A string representing the conversation_model.
     */
    matchConversationModelFromProjectConversationModelEvaluationsEvaluationName(projectConversationModelEvaluationsEvaluationName) {
        return this.pathTemplates.projectConversationModelEvaluationsEvaluationPathTemplate.match(projectConversationModelEvaluationsEvaluationName).conversation_model;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    projectLocationConversationModelEvaluationsEvaluationPath(project, location, conversationModel) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationConversationModelEvaluationsEvaluationName(projectLocationConversationModelEvaluationsEvaluationName) {
        return this.pathTemplates.projectLocationConversationModelEvaluationsEvaluationPathTemplate.match(projectLocationConversationModelEvaluationsEvaluationName).project;
    }
    /**
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationConversationModelEvaluationsEvaluationName(projectLocationConversationModelEvaluationsEvaluationName) {
        return this.pathTemplates.projectLocationConversationModelEvaluationsEvaluationPathTemplate.match(projectLocationConversationModelEvaluationsEvaluationName).location;
    }
    /**
     ...
     * @returns {string} A string representing the conversation_model.
     */
    matchConversationModelFromProjectLocationConversationModelEvaluationsEvaluationName(projectLocationConversationModelEvaluationsEvaluationName) {
        return this.pathTemplates.projectLocationConversationModelEvaluationsEvaluationPathTemplate.match(projectLocationConversationModelEvaluationsEvaluationName).conversation_model;
    }
    /**
