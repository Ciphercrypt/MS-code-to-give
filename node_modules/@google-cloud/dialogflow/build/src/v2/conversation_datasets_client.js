...
class ConversationDatasetsClient {
    ...
    async checkCreateConversationDatasetProgress(name) {
        ...
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createConversationDataset, gax.createDefaultBackoffSettings());
    ...
    async checkDeleteConversationDatasetProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deleteConversationDataset, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    ...
    async checkImportConversationDataProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.importConversationData, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
